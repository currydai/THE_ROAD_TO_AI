...
% Include the full Python source in the article
\lstinputlisting[style=code,caption={gen\_naive\_bayes\_figures.py},label={lst:source_nb}]{gen_naive_bayes_figures.py}
